Feature: Admin is able to create an exercise
  ...
  Scenario Outline: Admin fails to create a new exercise
    ...
    Examples:
      ...
      | "Jogging" | "" | "https://youtu.be/dQw4w9WgXcQ" | "Test Description" | "Create Exercise" | "Error... All fields must be filled in order to submit" |
      | "Jogging" | "Cardio" | "" | "Test Description" | "Create Exercise" | "Error... All fields must be filled in order to submit" |
      | "Jogging" | "Cardio" | "https://youtu.be/dQw4w9WgXcQ" | "" | "Create Exercise" | "Error... All fields must be filled in order to submit" |
